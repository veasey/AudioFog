<li class="playtrack" data-filepath="{{ $filepath }}" data-trackid="{{ $id }}">
  <div class="row">
    ...
    <div class="col">
      ...
      <svg data-toggle="tooltip" data-placement="top" title="More Info" class="bi bi-info-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
